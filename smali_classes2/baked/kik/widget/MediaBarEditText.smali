.class public Lbaked/kik/widget/MediaBarEditText;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 26
    invoke-direct {p0, p1}, Lbaked/kik/widget/ImeAwareEditText;-><init>(Landroid/content/Context;)V

    .line 27
    invoke-direct {p0, p1}, Lbaked/kik/widget/MediaBarEditText;->a(Landroid/content/Context;)V
...
.method private a(II)Ljava/lang/CharSequence;
    ...
    .line 92
    invoke-virtual {p0}, Lbaked/kik/widget/MediaBarEditText;->getText()Landroid/text/Editable;
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbaked/kik/widget/MediaBarEditText;->a:Landroid/content/ClipboardManager;
...
.method public onTextContextMenuItem(I)Z
    ...
    .line 50
    iget-object v1, p0, Lbaked/kik/widget/MediaBarEditText;->a:Landroid/content/ClipboardManager;

    if-nez v1, :cond_0

    .line 51
    invoke-super {p0, p1}, Lbaked/kik/widget/ImeAwareEditText;->onTextContextMenuItem(I)Z
    ...
    .line 55
    :cond_0
    invoke-virtual {p0}, Lbaked/kik/widget/MediaBarEditText;->length()I

    move-result v1

    .line 57
    invoke-virtual {p0}, Lbaked/kik/widget/MediaBarEditText;->isFocused()Z
    ...
    .line 58
    invoke-virtual {p0}, Lbaked/kik/widget/MediaBarEditText;->getSelectionStart()I

    move-result v1

    .line 59
    invoke-virtual {p0}, Lbaked/kik/widget/MediaBarEditText;->getSelectionEnd()I
    ...
    .line 66
    :pswitch_0
    iget-object v3, p0, Lbaked/kik/widget/MediaBarEditText;->a:Landroid/content/ClipboardManager;

    invoke-direct {p0, v2, v1}, Lbaked/kik/widget/MediaBarEditText;->a(II)Ljava/lang/CharSequence;
    ...
    .line 2082
    invoke-virtual {p0}, Lbaked/kik/widget/MediaBarEditText;->clearFocus()V
