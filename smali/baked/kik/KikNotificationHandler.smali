.class public Lbaked/kik/KikNotificationHandler;
.super Landroid/content/BroadcastReceiver;
.source "SourceFile"

# interfaces
.implements Lbaked/kik/e/e;
...
.field protected e:Lcom/baked/kik/Mixpanel;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.field protected g:Lbaked/kik/videochat/c;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field
...
.field private s:Lbaked/kik/g/b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->i:Ljava/lang/Object;

    .line 143
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lbaked/kik/KikNotificationHandler;->m:J

    .line 144
    iput v2, p0, Lbaked/kik/KikNotificationHandler;->n:I

    .line 145
    iput v2, p0, Lbaked/kik/KikNotificationHandler;->o:I
    ...
    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->p:Lcom/kik/events/d;

    .line 147
    const/4 v0, 0x0

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->q:Lcom/kik/events/Promise;
    ...
    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->r:Landroid/graphics/Paint;

    .line 161
    new-instance v0, Lbaked/kik/KikNotificationHandler$1;

    invoke-direct {v0, p0}, Lbaked/kik/KikNotificationHandler$1;-><init>(Lbaked/kik/KikNotificationHandler;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->t:Lcom/kik/events/e;

    .line 176
    new-instance v0, Lbaked/kik/KikNotificationHandler$2;

    invoke-direct {v0, p0}, Lbaked/kik/KikNotificationHandler$2;-><init>(Lbaked/kik/KikNotificationHandler;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->u:Lcom/kik/events/e;

    .line 186
    new-instance v0, Lbaked/kik/KikNotificationHandler$3;

    invoke-direct {v0, p0}, Lbaked/kik/KikNotificationHandler$3;-><init>(Lbaked/kik/KikNotificationHandler;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->v:Landroid/os/Handler;

    .line 202
    new-instance v0, Lbaked/kik/KikNotificationHandler$4;

    invoke-direct {v0, p0}, Lbaked/kik/KikNotificationHandler$4;-><init>(Lbaked/kik/KikNotificationHandler;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->w:Lcom/kik/events/e;

    .line 213
    new-instance v0, Lbaked/kik/KikNotificationHandler$5;

    invoke-direct {v0, p0}, Lbaked/kik/KikNotificationHandler$5;-><init>(Lbaked/kik/KikNotificationHandler;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->x:Lcom/kik/events/e;

    .line 224
    new-instance v0, Lbaked/kik/KikNotificationHandler$6;

    invoke-direct {v0, p0}, Lbaked/kik/KikNotificationHandler$6;-><init>(Lbaked/kik/KikNotificationHandler;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->y:Lcom/kik/events/e;

    .line 248
    new-instance v0, Lbaked/kik/KikNotificationHandler$7;

    invoke-direct {v0, p0}, Lbaked/kik/KikNotificationHandler$7;-><init>(Lbaked/kik/KikNotificationHandler;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->z:Lcom/kik/events/e;

    .line 261
    iput-object p1, p0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;

    .line 263
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;

    new-instance v1, Landroid/content/IntentFilter;

    const-string v2, "baked.kik.notificationHandler.ACTION_MESSAGE_READ"
    ...
    const-string v2, "baked.kik.notificationHandler.ACTION_MESSAGE_REPLY"
    ...
    const-string v2, "baked.kik.notificationHandler.ACTION_MESSAGE_DISMISS"
    ...
    const-string v2, "baked.kik.notificationHandler.ACTION_MESSAGE_OPEN"
    ...
    const-string v2, "baked.kik.notificationHandler.ACTION_MESSAGE_OPEN_VIDEO"
    ...
    const-string v2, "baked.kik.notificationHandler.ACTION_DISMISS_VIDEO"
    ...
    const-string v2, "baked.kik.notificationHandler.ACTION_OPEN_TROPHY_CASE"
    ...
    .line 271
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->r:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->h:Landroid/support/v4/app/NotificationManagerCompat;
...
.method private a(Ljava/util/List;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    const-string v1, "baked.kik.notificationHandler.ACTION_MESSAGE_OPEN"
    ...
    .line 1054
    const-string v0, "baked.kik.notificationHandler.ACTION_MESSAGE_OPEN_VIDEO"
...
.method private a(Lkik/core/datatypes/m;ZLjava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 1108
    :cond_1
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;
...
.method private a(Lkik/core/datatypes/f;Z)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;
    ...
    .line 522
    :cond_0
    invoke-direct {p0, p1}, Lbaked/kik/KikNotificationHandler;->c(Lkik/core/datatypes/f;)Lkik/core/datatypes/m;

    move-result-object v1

    .line 4282
    invoke-direct {p0, v1, v6, v7}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZI)Ljava/lang/String;
    ...
    iget-object v3, p0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;
    ...
    .line 530
    invoke-direct {p0}, Lbaked/kik/KikNotificationHandler;->e()Landroid/app/PendingIntent;
    ...
    .line 6036
    new-instance v3, Lbaked/kik/chat/fragment/KikConversationsFragment$a;

    invoke-direct {v3}, Lbaked/kik/chat/fragment/KikConversationsFragment$a;-><init>()V

    .line 6037
    invoke-virtual {v3}, Lbaked/kik/chat/fragment/KikConversationsFragment$a;->d()Lbaked/kik/chat/fragment/KikConversationsFragment$a;

    move-result-object v3

    .line 6038
    iget-object v4, p0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;

    invoke-static {v3, v4}, Lbaked/kik/chat/activity/KActivityLauncher;->a(Lbaked/kik/util/af;Landroid/content/Context;)Lbaked/kik/chat/activity/KActivityLauncher$ActivityLaunchDescriptor;

    move-result-object v3

    invoke-virtual {v3}, Lbaked/kik/chat/activity/KActivityLauncher$ActivityLaunchDescriptor;->b()Lbaked/kik/chat/activity/KActivityLauncher$ActivityLaunchDescriptor;

    move-result-object v3

    invoke-virtual {v3}, Lbaked/kik/chat/activity/KActivityLauncher$ActivityLaunchDescriptor;->d()Landroid/content/Intent;
    ...
    .line 538
    :cond_1
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;
    ...
    invoke-static {v1, v2, v3}, Lbaked/kik/g/c;->a(Lkik/core/interfaces/v;Lkik/core/datatypes/Message;Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    .line 539
    invoke-direct {p0, p1, v6}, Lbaked/kik/KikNotificationHandler;->b(Lkik/core/datatypes/f;Z)Landroid/app/PendingIntent;
...
.method private a(Lkik/core/datatypes/f;)Landroid/text/SpannableStringBuilder;
    ...
    invoke-direct {p0, v0, v4, v1}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZI)Ljava/lang/String;
    ...
    .line 473
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;
    ...
    invoke-static {v0, v2, v3}, Lbaked/kik/g/c;->a(Lkik/core/interfaces/v;Lkik/core/datatypes/Message;Landroid/content/Context;)Ljava/lang/CharSequence;
...
.method static synthetic a(Lbaked/kik/KikNotificationHandler;Lcom/kik/events/Promise;)Lcom/kik/events/Promise;
    .locals 0

    .prologue
    .line 89
    iput-object p1, p0, Lbaked/kik/KikNotificationHandler;->q:Lcom/kik/events/Promise;
...
.method private a(Lkik/core/datatypes/m;ZI)Ljava/lang/String;
    ...
    iget-object v5, p0, Lbaked/kik/KikNotificationHandler;->f:Lkik/core/interfaces/b;
    ...
    invoke-static/range {v0 .. v5}, Lbaked/kik/g/c;->a(Landroid/content/Context;Lkik/core/interfaces/v;Lkik/core/datatypes/m;ZILkik/core/interfaces/b;)Ljava/lang/String;
...
.method static synthetic a(Lbaked/kik/KikNotificationHandler;)Lkik/core/interfaces/j;
    .locals 1

    .prologue
    .line 89
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->l:Lkik/core/interfaces/j;
...
.method private a(ILandroid/app/Notification;)V
    ...
    .line 588
    :try_start_0
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->h:Landroid/support/v4/app/NotificationManagerCompat;
...
.method private a(Landroid/content/Intent;Z)V
    ...
    .line 1379
    :cond_0
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->e:Lcom/baked/kik/Mixpanel;
    ...
    .line 1394
    iget-object v5, p0, Lbaked/kik/KikNotificationHandler;->g:Lbaked/kik/videochat/c;

    invoke-interface {v5}, Lbaked/kik/videochat/c;->g()Lcom/rounds/kik/analytics/IReporterProxy;

    move-result-object v5

    iget-object v6, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;
    ...
    .line 1401
    invoke-static {v3}, Lbaked/kik/util/bx;->d(Ljava/lang/String;)Z
    ...
    .line 1403
    invoke-virtual {v0}, Lbaked/kik/chat/fragment/KikConversationsFragment$a;->d()Lbaked/kik/chat/fragment/KikConversationsFragment$a;
    ...
    invoke-static {v0, v1}, Lbaked/kik/chat/activity/KActivityLauncher;->b(Landroid/content/Intent;Landroid/content/Context;)Lcom/kik/events/Promise;

    goto :goto_0

    .line 1407
    :cond_2
    iget-object v4, p0, Lbaked/kik/KikNotificationHandler;->g:Lbaked/kik/videochat/c;

    iget-object v5, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;

    invoke-interface {v5, v3, v2}, Lkik/core/interfaces/v;->a(Ljava/lang/String;Z)Lkik/core/datatypes/m;

    move-result-object v5

    invoke-interface {v4, v5}, Lbaked/kik/videochat/c;->b(Lkik/core/datatypes/m;)Z
    ...
    .line 1413
    :cond_4
    new-instance v4, Lbaked/kik/chat/fragment/KikChatFragment$a;

    invoke-direct {v4}, Lbaked/kik/chat/fragment/KikChatFragment$a;-><init>()V

    .line 1414
    invoke-virtual {v4, v3}, Lbaked/kik/chat/fragment/KikChatFragment$a;->a(Ljava/lang/String;)Lbaked/kik/chat/fragment/KikChatFragment$a;

    move-result-object v4

    .line 1415
    invoke-virtual {v4, v3}, Lbaked/kik/chat/fragment/KikChatFragment$a;->c(Ljava/lang/String;)Lbaked/kik/chat/fragment/KikChatFragment$a;
    ...
    .line 1416
    :cond_5
    invoke-virtual {v3, v1}, Lbaked/kik/chat/fragment/KikChatFragment$a;->a(Z)Lbaked/kik/chat/fragment/KikChatFragment$a;
...
.method private a(Landroid/support/v4/app/NotificationCompat$InboxStyle;Ljava/util/List;)V
    ...
    .line 446
    invoke-direct {p0, v0}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/f;)Landroid/text/SpannableStringBuilder;
...
.method static synthetic a(Lbaked/kik/KikNotificationHandler;Lkik/core/datatypes/m;)V
    .locals 0

    .prologue
    .line 0
    .line 18290
    invoke-virtual {p0, p1}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;)V
...
.method private a(Ljava/util/List;)V
    ...
    .line 581
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->h:Landroid/support/v4/app/NotificationManagerCompat;
...
.method private a(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 1340
    iget-object v4, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;
    ...
    .line 1341
    iget-object v5, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    invoke-virtual {v5, v0}, Lbaked/kik/g/b;->a(Lkik/core/datatypes/f;)I

    move-result v5

    .line 1343
    iget-object v6, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    invoke-virtual {v6, v5}, Lbaked/kik/g/b;->a(I)Z
    ...
    .line 1344
    invoke-direct {p0, v0, v2}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/f;Z)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 1346
    invoke-direct {p0, v5, v0}, Lbaked/kik/KikNotificationHandler;->a(ILandroid/app/Notification;)V

    .line 1348
    :cond_2
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    invoke-virtual {v0, v4, v5, v2}, Lbaked/kik/g/b;->a(Lkik/core/datatypes/m;IZ)V
    ...
    .line 1352
    iget-object v3, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;
    ...
    .line 1353
    iget-object v4, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    invoke-virtual {v4, v0}, Lbaked/kik/g/b;->a(Lkik/core/datatypes/f;)I
    ...
    invoke-virtual {v4, v3, v0, v2}, Lbaked/kik/g/b;->a(Lkik/core/datatypes/m;IZ)V
...
.method private a(Lkik/core/datatypes/Message;Z)V
    ...
    iget-object v2, v0, Lbaked/kik/KikNotificationHandler;->l:Lkik/core/interfaces/j;
    ...
    iget-object v2, v0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;
    ...
    iget-object v2, v0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    invoke-virtual {v2, v6}, Lbaked/kik/g/b;->a(Lkik/core/datatypes/f;)I
    ...
    invoke-direct {v0, v6, v1}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/f;Z)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-direct {v0, v8, v2}, Lbaked/kik/KikNotificationHandler;->a(ILandroid/app/Notification;)V
    ...
    invoke-virtual {v2, v7, v8}, Lbaked/kik/g/b;->a(Lkik/core/datatypes/m;I)V
    ...
    invoke-direct {v0, v10, v3, v4}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZI)Ljava/lang/String;
    ...
    iget-object v13, v0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;
    ...
    invoke-static {v3}, Lbaked/kik/util/p;->a(Lkik/core/datatypes/messageExtensions/ContentMessage;)Ljava/lang/String;
    ...
    .line 6703
    invoke-direct/range {p0 .. p0}, Lbaked/kik/KikNotificationHandler;->h()Landroid/graphics/Bitmap;
    ...
    :cond_a
    :goto_4
    invoke-static {v2}, Lbaked/kik/KikNotificationHandler;->c(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;
    ...
    const-string v12, "baked.kik.notificationHandler.ACTION_MESSAGE_READ"
    ...
    iget-object v5, v0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;
    ...
    const-string v13, "baked.kik.notificationHandler.ACTION_MESSAGE_REPLY"
    ...
    iget-object v4, v0, Lbaked/kik/KikNotificationHandler;->j:Landroid/content/Context;
    ...
    invoke-direct {v0, v10}, Lbaked/kik/KikNotificationHandler;->d(Lkik/core/datatypes/m;)Lcom/kik/cache/ac;
    ...
    iget-object v3, v0, Lbaked/kik/KikNotificationHandler;->a:Lcom/kik/cache/ae;

    invoke-static {v3, v2}, Lbaked/kik/util/f;->a(Lcom/kik/cache/ae;Lcom/kik/cache/ac;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, v10}, Lbaked/kik/KikNotificationHandler;->c(Lkik/core/datatypes/m;)Landroid/graphics/Bitmap;
...
.method private a(ZZLkik/core/datatypes/Message;ZZ)V
    ...
    .prologue
    .line 763
    invoke-direct {p0}, Lbaked/kik/KikNotificationHandler;->i()I
    ...
    .line 770
    :cond_1
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->d:Lkik/core/interfaces/ac;
    ...
    .line 781
    invoke-static {v3, p2}, Lbaked/kik/g/c;->a(ZZ)[J
    ...
    .line 8493
    iget-object v7, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    invoke-virtual {v7, v0}, Lbaked/kik/g/b;->b(Ljava/util/List;)Ljava/util/List;
    ...
    .line 8497
    invoke-direct {p0, v0}, Lbaked/kik/KikNotificationHandler;->a(Ljava/util/List;)V

    .line 795
    :cond_8
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    invoke-virtual {v0, v2}, Lbaked/kik/g/b;->c(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v0, v4}, Lbaked/kik/g/b;->c(Ljava/util/List;)Ljava/util/List;
    ...
    .line 8752
    :goto_3
    invoke-direct {p0}, Lbaked/kik/KikNotificationHandler;->k()Z
    ...
    :cond_9
    :goto_4
    invoke-direct {p0, v7, v8}, Lbaked/kik/KikNotificationHandler;->a(Ljava/util/List;Ljava/util/List;)V

    .line 805
    invoke-direct {p0, p3, p4}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/Message;Z)V
    ...
    .line 812
    invoke-direct {p0}, Lbaked/kik/KikNotificationHandler;->j()I

    move-result v0

    .line 815
    invoke-direct {p0}, Lbaked/kik/KikNotificationHandler;->f()Landroid/app/PendingIntent;
    ...
    invoke-static {v7}, Lbaked/kik/chat/KikApplication;->e(I)Ljava/lang/String;
    ...
    .line 824
    invoke-direct {p0, v7, v2}, Lbaked/kik/KikNotificationHandler;->a(Landroid/support/v4/app/NotificationCompat$InboxStyle;Ljava/util/List;)V
    ...
    .line 827
    invoke-direct {p0, v7, v4}, Lbaked/kik/KikNotificationHandler;->b(Landroid/support/v4/app/NotificationCompat$InboxStyle;Ljava/util/List;)V
    ...
    invoke-static {v0}, Lbaked/kik/KikNotificationHandler;->b(Lkik/core/datatypes/f;)J
    ...
    invoke-virtual {v0}, Lbaked/kik/g/b;->c()I
    ...
    invoke-virtual {v0}, Lbaked/kik/g/b;->b()Ljava/util/List;
    ...
    check-cast v0, Lbaked/kik/g/a;

    invoke-virtual {v0}, Lbaked/kik/g/a;->a()Lkik/core/datatypes/m;
    ...
    iget-wide v2, p0, Lbaked/kik/KikNotificationHandler;->m:J
    ...
    invoke-static {v0}, Lbaked/kik/g/c;->a(Ljava/lang/String;)I
    ...
    .line 943
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->d:Lkik/core/interfaces/ac;
    ...
    invoke-static {v1}, Lbaked/kik/g/c;->a(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v1, v0}, Lbaked/kik/KikNotificationHandler;->a(ILandroid/app/Notification;)V
    ...
    iget-object v8, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;

    invoke-static {v0, v8, v2}, Lbaked/kik/g/c;->a(Landroid/content/Context;Lkik/core/interfaces/v;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v8, v9}, Lbaked/kik/chat/KikApplication;->a(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 851
    invoke-direct {p0, v4}, Lbaked/kik/KikNotificationHandler;->b(Ljava/util/List;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v0, v1}, Lbaked/kik/KikNotificationHandler;->b(Lkik/core/datatypes/f;Z)Landroid/app/PendingIntent;
    ...
    .line 864
    invoke-direct {p0, v0}, Lbaked/kik/KikNotificationHandler;->c(Lkik/core/datatypes/f;)Lkik/core/datatypes/m;

    move-result-object v2

    .line 865
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->a:Lcom/kik/cache/ae;

    invoke-direct {p0, v2}, Lbaked/kik/KikNotificationHandler;->d(Lkik/core/datatypes/m;)Lcom/kik/cache/ac;

    move-result-object v4

    invoke-static {v1, v4}, Lbaked/kik/util/f;->a(Lcom/kik/cache/ae;Lcom/kik/cache/ac;)Landroid/graphics/Bitmap;
    ...
    .line 867
    invoke-direct {p0, v2}, Lbaked/kik/KikNotificationHandler;->b(Lkik/core/datatypes/m;)V

    .line 868
    invoke-direct {p0, v2}, Lbaked/kik/KikNotificationHandler;->c(Lkik/core/datatypes/m;)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 870
    :cond_15
    invoke-direct {p0, v1}, Lbaked/kik/KikNotificationHandler;->b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v1}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/q;)Z
    ...
    .line 872
    :cond_16
    invoke-static {v4}, Lbaked/kik/KikNotificationHandler;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v2, v4, v7}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZI)Ljava/lang/String;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;
    ...
    invoke-static {v2, v0, v4}, Lbaked/kik/g/c;->a(Lkik/core/interfaces/v;Lkik/core/datatypes/Message;Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->l:Lkik/core/interfaces/j;
    ...
    .line 10990
    invoke-direct {p0, v1}, Lbaked/kik/KikNotificationHandler;->c(Lkik/core/datatypes/m;)Landroid/graphics/Bitmap;
    ...
    .line 10994
    invoke-direct {p0}, Lbaked/kik/KikNotificationHandler;->g()Landroid/graphics/Bitmap;
    ...
    .line 10997
    :cond_1d
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->a:Lcom/kik/cache/ae;

    invoke-direct {p0, v1}, Lbaked/kik/KikNotificationHandler;->d(Lkik/core/datatypes/m;)Lcom/kik/cache/ac;

    move-result-object v2

    invoke-static {v0, v2}, Lbaked/kik/util/f;->a(Lcom/kik/cache/ae;Lcom/kik/cache/ac;)Landroid/graphics/Bitmap;
    ...
    .line 10999
    invoke-direct {p0, v1}, Lbaked/kik/KikNotificationHandler;->b(Lkik/core/datatypes/m;)V
    ...
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->g:Lbaked/kik/videochat/c;
...
.method private a(Lkik/core/datatypes/q;)Z
    ...
    iget-object v3, p0, Lbaked/kik/KikNotificationHandler;->f:Lkik/core/interfaces/b;

    invoke-static {v3}, Lbaked/kik/util/a;->a(Lkik/core/interfaces/b;)Z
...
.method private static b(Lkik/core/manager/trophy/TrophyType;)I
    ...
    .prologue
    .line 417
    sget-object v0, Lbaked/kik/KikNotificationHandler$9;->a:[I
...
.method private b(Lkik/core/datatypes/f;Z)Landroid/app/PendingIntent;
    ...
    .line 1072
    .line 11080
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->c:Lkik/core/interfaces/m;
    ...
    invoke-direct {p0, v0, p2, v1}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZLjava/lang/String;)Landroid/app/PendingIntent;
...
.method private b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->r:Landroid/graphics/Paint;
...
.method private b(Ljava/util/List;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v0, v5, v4}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZI)Ljava/lang/String;
...
.method private b(Landroid/support/v4/app/NotificationCompat$InboxStyle;Ljava/util/List;)V
    ...
    .line 607
    :cond_0
    invoke-direct {p0, p2}, Lbaked/kik/KikNotificationHandler;->b(Ljava/util/List;)Ljava/lang/CharSequence;
...
.method static synthetic b(Lbaked/kik/KikNotificationHandler;)V
    .locals 1
    ...
    invoke-direct {p0, v0}, Lbaked/kik/KikNotificationHandler;->b(Z)V
...
.method private b(Lkik/core/datatypes/m;)V
    ...
    invoke-direct {p0, p1}, Lbaked/kik/KikNotificationHandler;->d(Lkik/core/datatypes/m;)Lcom/kik/cache/ac;
    ...
    .line 968
    new-instance v1, Lbaked/kik/KikNotificationHandler$8;

    invoke-direct {v1, p0}, Lbaked/kik/KikNotificationHandler$8;-><init>(Lbaked/kik/KikNotificationHandler;)V
...
.method private c(Lkik/core/datatypes/m;)Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->f:Lkik/core/interfaces/b;
...
.method static synthetic c(Lbaked/kik/KikNotificationHandler;)Lcom/kik/events/Promise;
    .locals 1

    .prologue
    .line 89
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->q:Lcom/kik/events/Promise;
...
.method private d(Lkik/core/datatypes/m;)Lcom/kik/cache/ac;
    ...
    .line 1232
    invoke-static {v0}, Lbaked/kik/KikNotificationHandler;->e(Lkik/core/datatypes/m;)Lcom/kik/cache/ac;
    ...
    iget-object v8, p0, Lbaked/kik/KikNotificationHandler;->a:Lcom/kik/cache/ae;

    iget-object v9, p0, Lbaked/kik/KikNotificationHandler;->e:Lcom/baked/kik/Mixpanel;

    move v3, v2

    move v7, v2

    invoke-static/range {v0 .. v9}, Lcom/kik/cache/v;->a(Lkik/core/datatypes/q;Lcom/android/volley/i$b;IILandroid/graphics/Bitmap$Config;Lcom/android/volley/i$a;Lkik/core/interfaces/v;ZLcom/kik/cache/ae;Lcom/baked/kik/Mixpanel;)Lcom/kik/cache/v;
    ...
    .line 1240
    :cond_2
    invoke-static {p1}, Lbaked/kik/KikNotificationHandler;->e(Lkik/core/datatypes/m;)Lcom/kik/cache/ac;
...
.method static synthetic d(Lbaked/kik/KikNotificationHandler;)Ljava/lang/Object;
    .locals 1

    .prologue
    .line 89
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->i:Ljava/lang/Object;
...
.method private e()Landroid/app/PendingIntent;
    ...
    const-string v1, "baked.kik.notificationHandler.ACTION_MESSAGE_DISMISS"
...
.method private f()Landroid/app/PendingIntent;
    ...
    .line 1044
    invoke-direct {p0, v0, v0}, Lbaked/kik/KikNotificationHandler;->a(Ljava/util/List;Ljava/lang/String;)Landroid/app/PendingIntent;
...
.method private i()I
    ...
    .line 1252
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->l:Lkik/core/interfaces/j;
...
.method private j()I
    ...
    invoke-virtual {v0, v1}, Lbaked/kik/g/b;->c(Ljava/util/List;)Ljava/util/List;
...
.method private k()Z
    ...
    .line 1273
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->k:Lkik/core/interfaces/ae;
...
.method public final a(Lkik/core/datatypes/Message;ZZ)V
    ...
    .line 378
    invoke-direct/range {v0 .. v5}, Lbaked/kik/KikNotificationHandler;->a(ZZLkik/core/datatypes/Message;ZZ)V
    ...
    iput v0, p0, Lbaked/kik/KikNotificationHandler;->o:I
    ...
    iput v0, p0, Lbaked/kik/KikNotificationHandler;->n:I
...
.method public final a(Lkik/core/datatypes/m;)V
    ...
    invoke-interface {v0}, Lbaked/kik/videochat/c;->d()Ljava/util/List;
    ...
    iget-object v5, p0, Lbaked/kik/KikNotificationHandler;->d:Lkik/core/interfaces/ac;
    ...
    invoke-static {v5, v2}, Lbaked/kik/g/c;->a(ZZ)[J
    ...
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->f:Lkik/core/interfaces/b;
    ...
    invoke-direct {p0, v0, v2, v7}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZI)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v2, v5}, Lbaked/kik/KikNotificationHandler;->a(Lkik/core/datatypes/m;ZLjava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 16121
    invoke-direct {p0, v3, v5}, Lbaked/kik/KikNotificationHandler;->a(Ljava/util/List;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 17044
    :cond_7
    invoke-direct {p0, v10, v10}, Lbaked/kik/KikNotificationHandler;->a(Ljava/util/List;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 14552
    invoke-direct {p0, v9, v0}, Lbaked/kik/KikNotificationHandler;->a(ILandroid/app/Notification;)V
    ...
    .line 14554
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->g:Lbaked/kik/videochat/c;

    invoke-interface {v2}, Lbaked/kik/videochat/c;->g()Lcom/rounds/kik/analytics/IReporterProxy;
...
.method public final a(Lkik/core/interfaces/ae;Lkik/core/interfaces/j;Lkik/core/interfaces/ac;Lcom/kik/components/CoreComponent;)V
    ...
    .prologue
    .line 278
    invoke-interface {p4, p0}, Lcom/kik/components/CoreComponent;->a(Lbaked/kik/KikNotificationHandler;)V

    .line 279
    iput-object p2, p0, Lbaked/kik/KikNotificationHandler;->l:Lkik/core/interfaces/j;

    .line 280
    iput-object p1, p0, Lbaked/kik/KikNotificationHandler;->k:Lkik/core/interfaces/ae;

    .line 281
    iget-object v0, p0, Lbaked/kik/KikNotificationHandler;->p:Lcom/kik/events/d;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->y:Lcom/kik/events/e;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->w:Lcom/kik/events/e;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->x:Lcom/kik/events/e;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->t:Lcom/kik/events/e;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->u:Lcom/kik/events/e;
    ...
    iget-object v2, p0, Lbaked/kik/KikNotificationHandler;->z:Lcom/kik/events/e;
    ...
    instance-of v0, v0, Lbaked/kik/chat/KikApplication;

    if-eqz v0, :cond_0

    .line 289
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->p:Lcom/kik/events/d;
    ...
    invoke-static {p0}, Lbaked/kik/j;->a(Lbaked/kik/KikNotificationHandler;)Lcom/kik/events/e;
    ...
    .line 293
    :cond_0
    new-instance v0, Lbaked/kik/g/b;

    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->b:Lkik/core/interfaces/v;

    invoke-direct {v0, v1, p3}, Lbaked/kik/g/b;-><init>(Lkik/core/interfaces/v;Lkik/core/interfaces/ac;)V

    iput-object v0, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;
    ...
    invoke-virtual {v0, v2}, Lbaked/kik/g/b;->a(Ljava/util/List;)V
...
.method public final a(Lkik/core/manager/trophy/TrophyType;)V
    ...
    .line 405
    invoke-static {p1}, Lbaked/kik/KikNotificationHandler;->b(Lkik/core/manager/trophy/TrophyType;)I
...
.method public final a(Z)V
    ...
    iget-wide v4, p0, Lbaked/kik/KikNotificationHandler;->m:J
    ...
    .line 349
    iget-object v3, p0, Lbaked/kik/KikNotificationHandler;->v:Landroid/os/Handler;
    ...
    :cond_0
    :goto_0
    iput v6, p0, Lbaked/kik/KikNotificationHandler;->o:I

    .line 360
    iput v7, p0, Lbaked/kik/KikNotificationHandler;->n:I
    ...
    .line 351
    :cond_1
    iget v1, p0, Lbaked/kik/KikNotificationHandler;->o:I

    if-ne v6, v1, :cond_2

    iget v1, p0, Lbaked/kik/KikNotificationHandler;->n:I
    ...
    iget-object v1, p0, Lbaked/kik/KikNotificationHandler;->s:Lbaked/kik/g/b;

    .line 3228
    invoke-virtual {v1}, Lbaked/kik/g/b;->c()I
...
.method public final d()V
    ...
    invoke-virtual {v0}, Lbaked/kik/g/b;->a()V

    .line 1325
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lbaked/kik/KikNotificationHandler;->a(Z)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 1297
    :cond_1
    const-string v1, "baked.kik.notificationHandler.ACTION_MESSAGE_READ"
    ...
    .line 1300
    :cond_2
    const-string v1, "baked.kik.notificationHandler.ACTION_MESSAGE_REPLY"
    ...
    invoke-virtual {v0}, Lbaked/kik/g/b;->d()V
    ...
    .line 1307
    invoke-direct {p0, p2, v0}, Lbaked/kik/KikNotificationHandler;->a(Landroid/content/Intent;Z)V

    goto/16 :goto_0

    .line 1309
    :cond_6
    const-string v1, "baked.kik.notificationHandler.ACTION_MESSAGE_OPEN_VIDEO"
    ...
    .line 1310
    invoke-direct {p0, p2, v7}, Lbaked/kik/KikNotificationHandler;->a(Landroid/content/Intent;Z)V

    goto/16 :goto_0

    .line 1312
    :cond_7
    const-string v1, "baked.kik.notificationHandler.ACTION_DISMISS_VIDEO"
    ...
    .line 13444
    iget-object v3, p0, Lbaked/kik/KikNotificationHandler;->g:Lbaked/kik/videochat/c;

    invoke-interface {v3, v1}, Lbaked/kik/videochat/c;->a([Ljava/lang/String;)V
    ...
    .line 1315
    :cond_8
    const-string v0, "baked.kik.notificationHandler.ACTION_OPEN_TROPHY_CASE"
    ...
    .line 14429
    new-instance v0, Lbaked/kik/chat/fragment/TrophyCaseFragment$a;

    invoke-direct {v0}, Lbaked/kik/chat/fragment/TrophyCaseFragment$a;-><init>()V
