.class public final Lbaked/kik/chat/vm/chats/c;
.super Lbaked/kik/chat/vm/c;
.source "SourceFile"

# interfaces
.implements Lbaked/kik/chat/vm/chats/a;
...
.field private final f:Lbaked/kik/chat/vm/chats/b;

.field private final g:I


# direct methods
.method public constructor <init>(Ljava/lang/String;Lbaked/kik/chat/vm/chats/b;I)V
    .locals 0
    ...
    .line 42
    iput-object p1, p0, Lbaked/kik/chat/vm/chats/c;->e:Ljava/lang/String;

    .line 43
    iput-object p2, p0, Lbaked/kik/chat/vm/chats/c;->f:Lbaked/kik/chat/vm/chats/b;

    .line 44
    iput p3, p0, Lbaked/kik/chat/vm/chats/c;->g:I

    .line 45
    return-void
.end method

.method static synthetic a(Lbaked/kik/chat/vm/chats/c;)V
    .locals 4

    .prologue
    .line 0
    .line 2110
    iget-object v0, p0, Lbaked/kik/chat/vm/chats/c;->f:Lbaked/kik/chat/vm/chats/b;

    iget-object v1, p0, Lbaked/kik/chat/vm/chats/c;->e:Ljava/lang/String;

    invoke-interface {v0, v1}, Lbaked/kik/chat/vm/chats/b;->a(Ljava/lang/String;)V

    .line 2111
    iget-object v0, p0, Lbaked/kik/chat/vm/chats/c;->d:Lcom/baked/kik/Mixpanel;
    ...
    iget v2, p0, Lbaked/kik/chat/vm/chats/c;->g:I
...
.method public final J_()V
    ...
    .line 91
    iget-object v0, p0, Lbaked/kik/chat/vm/chats/c;->b:Lkik/core/interfaces/v;
    ...
    .line 97
    iget-object v0, p0, Lbaked/kik/chat/vm/chats/c;->a:Landroid/content/res/Resources;
    ...
    .line 98
    iget-object v1, p0, Lbaked/kik/chat/vm/chats/c;->a:Landroid/content/res/Resources;
    ...
    .line 104
    :goto_1
    invoke-virtual {p0}, Lbaked/kik/chat/vm/chats/c;->Y_()Lbaked/kik/chat/vm/z;

    move-result-object v2

    new-instance v3, Lbaked/kik/chat/vm/DialogViewModel$b;

    invoke-direct {v3}, Lbaked/kik/chat/vm/DialogViewModel$b;-><init>()V

    sget-object v4, Lbaked/kik/chat/vm/DialogViewModel$DialogStyle;->PLAIN:Lbaked/kik/chat/vm/DialogViewModel$DialogStyle;

    .line 105
    invoke-virtual {v3, v4}, Lbaked/kik/chat/vm/DialogViewModel$b;->a(Lbaked/kik/chat/vm/DialogViewModel$DialogStyle;)Lbaked/kik/chat/vm/DialogViewModel$b;

    move-result-object v3

    .line 106
    invoke-virtual {v3}, Lbaked/kik/chat/vm/DialogViewModel$b;->b()Lbaked/kik/chat/vm/DialogViewModel$b;

    move-result-object v3

    .line 107
    invoke-virtual {v3, v0}, Lbaked/kik/chat/vm/DialogViewModel$b;->a(Ljava/lang/String;)Lbaked/kik/chat/vm/DialogViewModel$b;
    ...
    invoke-static {p0}, Lbaked/kik/chat/vm/chats/d;->a(Lbaked/kik/chat/vm/chats/c;)Ljava/lang/Runnable;

    move-result-object v3

    invoke-virtual {v0, v1, v3}, Lbaked/kik/chat/vm/DialogViewModel$b;->a(Ljava/lang/String;Ljava/lang/Runnable;)Lbaked/kik/chat/vm/DialogViewModel$b;
    ...
    invoke-virtual {v0, v1, v3}, Lbaked/kik/chat/vm/DialogViewModel$b;->b(Ljava/lang/String;Ljava/lang/Runnable;)Lbaked/kik/chat/vm/DialogViewModel$b;
    ...
    .line 104
    invoke-interface {v2, v0}, Lbaked/kik/chat/vm/z;->a(Lbaked/kik/chat/vm/DialogViewModel;)V
    ...
    .line 102
    iget-object v2, p0, Lbaked/kik/chat/vm/chats/c;->a:Landroid/content/res/Resources;
...
.method public final K_()Z
    ...
    iget-object v2, p0, Lbaked/kik/chat/vm/chats/c;->e:Ljava/lang/String;
...
.method public final a()Lrx/c;
    ...
    .line 59
    :cond_0
    iget-object v1, p0, Lbaked/kik/chat/vm/chats/c;->c:Lkik/core/interfaces/g;
...
.method public final a(Lcom/kik/components/CoreComponent;Lbaked/kik/chat/vm/z;)V
    ...
    .line 51
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lbaked/kik/chat/vm/chats/c;)V
...
.method public final b()Lrx/c;
    ...
    .line 69
    iget-object v0, p0, Lbaked/kik/chat/vm/chats/c;->e:Ljava/lang/String;

    .line 1146
    iget-object v1, p0, Lbaked/kik/chat/vm/chats/c;->b:Lkik/core/interfaces/v;
    ...
    .line 1154
    :cond_0
    iget-object v2, p0, Lbaked/kik/chat/vm/chats/c;->b:Lkik/core/interfaces/v;
