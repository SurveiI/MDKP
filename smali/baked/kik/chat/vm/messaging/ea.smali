.class public Lbaked/kik/chat/vm/messaging/ea;
.super Lbaked/kik/chat/vm/messaging/bq;
.source "SourceFile"

# interfaces
.implements Lbaked/kik/chat/vm/messaging/df;
...
.method static synthetic a([B)Landroid/graphics/Bitmap;
    ...
    .line 0
    .line 1124
    invoke-static {p0}, Lbaked/kik/util/h;->a([B)Landroid/graphics/Bitmap;
...
.method public T()V
    ...
    .prologue
    .line 150
    invoke-super {p0}, Lbaked/kik/chat/vm/messaging/bq;->T()V

    .line 152
    iget-object v0, p0, Lbaked/kik/chat/vm/messaging/ea;->n:Lcom/baked/kik/Mixpanel;
...
.method public final a(Lcom/kik/components/CoreComponent;Lbaked/kik/chat/vm/z;)V
    ...
    .line 69
    invoke-interface {p1, p0}, Lcom/kik/components/CoreComponent;->a(Lbaked/kik/chat/vm/messaging/ea;)V
...
.method protected final al()Ljava/util/List;
    ...
    .prologue
    .line 130
    invoke-virtual {p0}, Lbaked/kik/chat/vm/messaging/ea;->l()Lkik/core/datatypes/messageExtensions/ContentMessage;
    ...
    .line 141
    invoke-super {p0}, Lbaked/kik/chat/vm/messaging/bq;->al()Ljava/util/List;
...
.method public final am()Lbaked/kik/chat/vm/messaging/IMessageViewModel$LayoutType;
    ...
    .prologue
    .line 75
    sget-object v0, Lbaked/kik/chat/vm/messaging/IMessageViewModel$LayoutType;->Sticker:Lbaked/kik/chat/vm/messaging/IMessageViewModel$LayoutType;
...
.method public ax()Lrx/c;
    ...
    .line 87
    new-instance v2, Lbaked/kik/chat/vm/messaging/ea$1;

    invoke-direct {v2, p0, v0}, Lbaked/kik/chat/vm/messaging/ea$1;-><init>(Lbaked/kik/chat/vm/messaging/ea;Ljava/lang/String;)V
    ...
    invoke-static {}, Lbaked/kik/chat/vm/messaging/eb;->a()Lrx/b/g;
...
.method public final k()Lrx/c;
    ...
    .prologue
    .line 172
    invoke-virtual {p0}, Lbaked/kik/chat/vm/messaging/ea;->C()Lrx/c;
