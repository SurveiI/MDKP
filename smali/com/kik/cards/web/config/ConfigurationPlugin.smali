...
.field private d:Lbaked/kik/util/an;
...
.method public constructor <init>(Lcom/kik/cards/web/config/a;Lbaked/kik/util/an;)V
    .locals 1
    ...
    .line 33
    iput-object p2, p0, Lcom/kik/cards/web/config/ConfigurationPlugin;->d:Lbaked/kik/util/an;

    .line 34
    return-void
.end method

.method private static a(Lbaked/kik/config/Configuration$Type;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 1
    ...
    .line 210
    :cond_2
    sget-object v0, Lbaked/kik/config/Configuration$Type;->Integer:Lbaked/kik/config/Configuration$Type;
...
.method private static a(Lbaked/kik/config/Configuration;)Lorg/json/JSONObject;
    .locals 5
    ...
    invoke-virtual {p0}, Lbaked/kik/config/Configuration;->c()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lbaked/kik/config/Configuration;->a()Lbaked/kik/config/Configuration$Type;

    move-result-object v0

    .line 2186
    sget-object v3, Lbaked/kik/config/Configuration$Type;->String:Lbaked/kik/config/Configuration$Type;
    ...
    .line 168
    invoke-virtual {p0}, Lbaked/kik/config/Configuration;->e()Ljava/util/List;
    ...
    invoke-static {v4, v3}, Lcom/kik/cards/web/config/ConfigurationPlugin;->a(Lbaked/kik/config/Configuration$Type;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_1
    sget-object v3, Lbaked/kik/config/Configuration$Type;->Integer:Lbaked/kik/config/Configuration$Type;

    if-eq v0, v3, :cond_1

    sget-object v3, Lbaked/kik/config/Configuration$Type;->Long:Lbaked/kik/config/Configuration$Type;
    ...
    .line 2192
    :cond_2
    sget-object v3, Lbaked/kik/config/Configuration$Type;->Boolean:Lbaked/kik/config/Configuration$Type;
    ...
    invoke-virtual {p0}, Lbaked/kik/config/Configuration;->d()Ljava/lang/Object;

    move-result-object v3

    invoke-static {v2, v3}, Lcom/kik/cards/web/config/ConfigurationPlugin;->a(Lbaked/kik/config/Configuration$Type;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lbaked/kik/config/Configuration;->b()Ljava/lang/Object;
...
.method public getAvailableServerProfiles(Lorg/json/JSONObject;)Lcom/kik/cards/web/plugin/h;
    ...
    invoke-interface {v0}, Lcom/kik/cards/web/config/a;->b()Lbaked/kik/config/b;
...
.method public getCurrentServerProfile(Lorg/json/JSONObject;)Lcom/kik/cards/web/plugin/h;
    ...
    iget-object v1, p0, Lcom/kik/cards/web/config/ConfigurationPlugin;->d:Lbaked/kik/util/an;
...
.method public getPreference(Lorg/json/JSONObject;)Lcom/kik/cards/web/plugin/h;
    ...
    invoke-interface {v1}, Lcom/kik/cards/web/config/a;->b()Lbaked/kik/config/b;

    move-result-object v1

    invoke-interface {v1, v0}, Lbaked/kik/config/b;->a(Ljava/lang/String;)Lbaked/kik/config/Configuration;
    ...
    invoke-virtual {v0}, Lbaked/kik/config/Configuration;->a()Lbaked/kik/config/Configuration$Type;
    ...
    invoke-static {v3, v0}, Lcom/kik/cards/web/config/ConfigurationPlugin;->a(Lbaked/kik/config/Configuration$Type;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getPreferenceList(Lorg/json/JSONObject;)Lcom/kik/cards/web/plugin/h;
    ...
    invoke-interface {v0}, Lbaked/kik/config/b;->a()Ljava/util/Collection;
    ...
    check-cast v0, Lbaked/kik/config/Configuration;

    .line 43
    invoke-static {v0}, Lcom/kik/cards/web/config/ConfigurationPlugin;->a(Lbaked/kik/config/Configuration;)Lorg/json/JSONObject;
...
.method public setCurrentServerProfile(Lorg/json/JSONObject;)Lcom/kik/cards/web/plugin/h;
    ...
    invoke-interface {v1, v0}, Lbaked/kik/config/b;->b(Ljava/lang/String;)Z
...
.method public setPreference(Lorg/json/JSONObject;)Lcom/kik/cards/web/plugin/h;
    ...
    invoke-interface {v2}, Lcom/kik/cards/web/config/a;->b()Lbaked/kik/config/b;

    move-result-object v2

    invoke-interface {v2, v1}, Lbaked/kik/config/b;->a(Ljava/lang/String;)Lbaked/kik/config/Configuration;
    ...
    .line 94
    :cond_2
    invoke-virtual {v1}, Lbaked/kik/config/Configuration;->a()Lbaked/kik/config/Configuration$Type;
    ...
    .line 94
    :goto_1
    invoke-virtual {v1, v0}, Lbaked/kik/config/Configuration;->a(Ljava/lang/Object;)Z
