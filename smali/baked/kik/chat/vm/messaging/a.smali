.class public abstract Lbaked/kik/chat/vm/messaging/a;
.super Lbaked/kik/chat/vm/messaging/AbstractMessageViewModel;
.source "SourceFile"


# instance fields
.field protected a:Lbaked/kik/net/http/b;
...
.field protected c:Lbaked/kik/videochat/c;
    .annotation runtime Ljavax/inject/Inject;
    .end annotation
.end field

.field protected d:Lbaked/kik/internal/platform/b;
...
.method public constructor <init>(Lkik/core/datatypes/Message;Ljava/lang/String;Lrx/c;Lrx/c;Lrx/c;Lrx/c;)V
    ...
    iput-object v0, p0, Lbaked/kik/chat/vm/messaging/a;->d:Lbaked/kik/internal/platform/b;

    .line 55
    return-void
.end method

.method static synthetic a(Lbaked/kik/chat/vm/messaging/a;)Lrx/c;
    .locals 1

    .prologue
    .line 37
    invoke-super {p0}, Lbaked/kik/chat/vm/messaging/AbstractMessageViewModel;->n()Lrx/c;
...
.method static synthetic a(Lbaked/kik/chat/vm/messaging/a;Z)V
    .locals 1
    ...
    invoke-direct {p0, p1, v0}, Lbaked/kik/chat/vm/messaging/a;->a(ZZ)V
...
.method private a(ZZ)V
    ...
    iget-object v0, p0, Lbaked/kik/chat/vm/messaging/a;->c:Lbaked/kik/videochat/c;
    ...
    new-instance v1, Lbaked/kik/chat/vm/messaging/a$2;

    invoke-direct {v1, p0, p1}, Lbaked/kik/chat/vm/messaging/a$2;-><init>(Lbaked/kik/chat/vm/messaging/a;Z)V
    ...
    .line 176
    :cond_0
    invoke-virtual {p0}, Lbaked/kik/chat/vm/messaging/a;->l()Lkik/core/datatypes/messageExtensions/ContentMessage;

    move-result-object v3

    .line 177
    invoke-virtual {p0}, Lbaked/kik/chat/vm/messaging/a;->s()Lkik/core/datatypes/Message;
    ...
    .line 180
    iget-object v0, p0, Lbaked/kik/chat/vm/messaging/a;->a:Lbaked/kik/net/http/b;

    invoke-virtual {v3}, Lkik/core/datatypes/messageExtensions/ContentMessage;->n()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Lbaked/kik/net/http/b;->a(Ljava/lang/String;)Ljava/lang/ref/WeakReference;
    ...
    .line 185
    invoke-virtual {v0, v3}, Lbaked/kik/net/http/ContentUploadItem;->a(Lkik/core/datatypes/messageExtensions/ContentMessage;)V

    .line 189
    :cond_1
    iget-object v0, p0, Lbaked/kik/chat/vm/messaging/a;->n:Lcom/baked/kik/Mixpanel;
    ...
    invoke-virtual {v0, v5, v6}, Lcom/baked/kik/Mixpanel$d;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/baked/kik/Mixpanel$d;
    ...
    :goto_1
    invoke-virtual {v5, v6, v0}, Lcom/baked/kik/Mixpanel$d;->a(Ljava/lang/String;Z)Lcom/baked/kik/Mixpanel$d;
    ...
    .line 194
    invoke-virtual {v0, v4, p1}, Lcom/baked/kik/Mixpanel$d;->a(Ljava/lang/String;Z)Lcom/baked/kik/Mixpanel$d;

    move-result-object v0

    const-string v4, "Share Icon Variant"

    iget-object v5, p0, Lbaked/kik/chat/vm/messaging/a;->b:Lkik/core/interfaces/b;
    ...
    .line 202
    :cond_2
    iget-object v0, p0, Lbaked/kik/chat/vm/messaging/a;->d:Lbaked/kik/internal/platform/b;
    ...
    invoke-virtual {v0, v4, v2}, Lbaked/kik/internal/platform/b;->a(Lkik/core/datatypes/messageExtensions/ContentMessage;Z)V

    .line 204
    invoke-virtual {p0}, Lbaked/kik/chat/vm/messaging/a;->Y_()Lbaked/kik/chat/vm/z;

    move-result-object v0

    new-instance v1, Lbaked/kik/chat/vm/messaging/a$3;

    invoke-direct {v1, p0}, Lbaked/kik/chat/vm/messaging/a$3;-><init>(Lbaked/kik/chat/vm/messaging/a;)V
...
.method public n()Lrx/c;
    ...
    .prologue
    .line 89
    invoke-virtual {p0}, Lbaked/kik/chat/vm/messaging/a;->m()Lrx/c;

    move-result-object v0

    new-instance v1, Lbaked/kik/chat/vm/messaging/a$1;

    invoke-direct {v1, p0}, Lbaked/kik/chat/vm/messaging/a$1;-><init>(Lbaked/kik/chat/vm/messaging/a;)V
...
.method public o()V
    ...
    .line 120
    iget-object v1, p0, Lbaked/kik/chat/vm/messaging/a;->b:Lkik/core/interfaces/b;
    ...
    .line 123
    iget-object v1, p0, Lbaked/kik/chat/vm/messaging/a;->n:Lcom/baked/kik/Mixpanel;
    ...
    .line 125
    iget-object v2, p0, Lbaked/kik/chat/vm/messaging/a;->f:Lkik/core/interfaces/v;
    ...
    new-instance v3, Lbaked/kik/chat/vm/k;

    invoke-virtual {v0}, Lkik/core/datatypes/u;->a()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v3, v4}, Lbaked/kik/chat/vm/k;-><init>(Ljava/lang/String;)V

    invoke-interface {v2, v3}, Lbaked/kik/chat/vm/z;->a(Lbaked/kik/chat/vm/n;)V
    ...
    invoke-virtual {p0}, Lbaked/kik/chat/vm/messaging/a;->p()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v0, v2}, Lcom/baked/kik/Mixpanel$d;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/baked/kik/Mixpanel$d;
    ...
    new-instance v3, Lbaked/kik/chat/vm/j;
    ...
    invoke-direct {v3, v4, v5, v7, v6}, Lbaked/kik/chat/vm/j;-><init>(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;)V

    .line 132
    invoke-interface {v2, v3}, Lbaked/kik/chat/vm/z;->a(Lbaked/kik/chat/vm/m;)V
    ...
    .line 154
    :cond_3
    invoke-super {p0}, Lbaked/kik/chat/vm/messaging/AbstractMessageViewModel;->o()V
